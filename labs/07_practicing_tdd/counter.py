...
def update_counter(name):
    ...
    return { name: COUNTERS[name] }, status.HTTP_200_OK # Implement update a counter, code pasted from step 07.02
...
def read_counter(name):
    ...
    return { name: counter }, status.HTTP_200_OK # Step 4: Implement read a counter, code pasted from step 07.04
