...
class CounterTest(TestCase):
    ...
    def test_update_a_counter(self):
        ...
        data = result.get_json()
        self.assertEqual(data["baz"], baseline + 1)  #Write a test for update a counter, code pasted from Step 07.01
    ...
    def test_read_a_counter(self):
        ...
        self.assertEqual(result.status_code, status.HTTP_200_OK)
        data = result.get_json()
        self.assertEqual(data["bin"], 0) # Step 3: Write a test for read a counter, code pasted from Step 07.03
    ...
    def test_delete_a_counter(self):
        ...
        self.assertEqual(result.status_code, status.HTTP_204_NO_CONTENT) # Step 5: Write a test for delete a counter, code pasted from Step 07.05