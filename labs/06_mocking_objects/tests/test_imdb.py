...
class TestIMDbDatabase(TestCase):
    ...
    def test_search_by_title(self, imdb_mock):
        ...
        self.assertEqual(results["results"][0]["id"], "tt1375666") # Step 1: Test Search by Title, pasted from Step 06.01
    ...
    def test_search_with_no_results(self, imdb_mock):
        ...
        imdb = IMDb("k_12345678")
        results = imdb.search_titles("Bambi")
        self.assertEqual(results, {}) # Step 2: Search with No Result, pasted from Step 06.02
    ...
    def test_search_by_title_failed(self, imdb_mock):
        ...
        results = imdb.search_titles("Bambi")
        self.assertIsNotNone(results)
        self.assertEqual(results["errorMessage"], "Invalid API Key") # Step 3: Search by Title Failed, pasted from Step 06.03
    ...
    def test_movie_ratings(self, imdb_mock):
        ...
        self.assertEqual(results["rottenTomatoes"], 5) # Step 4: Test Movie Ratings, pasted from Step 06.04